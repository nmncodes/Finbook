...
## Update
I am pleased to inform you that the name of this repository has been changed from Arc Invoice to finbook.
...
- This project is [MIT](https://github.com/finbook/blob/master/LICENSE.md) licensed.